        ...
        <div className="flex flex-col gap-10">
          <div className="flex flex-col items-center justify-center h-[75vh] md:h-[85vh]">
            <div className="flex flex-col gap-2 p-4">
              ...
              <p className="text-sm md:text-center text-balance md:text-lg">
                Simplify your finances with intuitive tools, intelligent
                insights, and total control over your spending and saving. Start
                today.
              </p>
            ...
            <div className="flex flex-col items-center justify-center gap-4 text-center ">
              ...
              <div className="grid w-full gap-4 md:px-10 md:grid-cols-3">
                ...
                <Card className="p-5 md:mx-0 md:p-10">
                  ...
                  <p>
                    Pengelompokan transaksi berdasarkan kategori (seperti
                    Makanan, Transportasi, Hiburan) untuk melihat ke mana uang
                    Anda pergi.
                  </p>
                </Card>
                <Card className="p-5 md:mx-0 md:p-10">
          ...
          <div className="flex flex-col items-center justify-center text-center border">
            <div>
              <h2>Contact</h2>
              <p>
                Jika Anda memiliki pertanyaan, saran, atau masalah, silakan
